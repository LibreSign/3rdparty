...
namespace OCA\Libresign\Vendor\MaxMind\Db;

use OCA\Libresign\Vendor\MaxMind\Db\Reader\Decoder;
use OCA\Libresign\Vendor\MaxMind\Db\Reader\InvalidDatabaseException;
use OCA\Libresign\Vendor\MaxMind\Db\Reader\Metadata;
use OCA\Libresign\Vendor\MaxMind\Db\Reader\Util;
/**
...
class Reader
{
    ...
    public function getWithPrefixLen(string $ipAddress) : array
    {
        ...
        if ($this->lookupInProgress) {
            throw new \BadMethodCallException('A lookup is already in progress on this reader. Use a separate reader for nested lookups.');
        }
