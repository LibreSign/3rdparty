...
final class TstInfoParser
{
    ...
    public function parse(string $encoded, array $certificateSubject) : ?TimestampToken
    {
        ...
        return new TimestampToken($fields['generatedAt'], $fields['policyOid'], $fields['serialNumber'], $certificateSubject);
    }
    /**
    ...
    private function readFields(array $nodes) : array
    {
        ...
        return ['generatedAt' => $this->findGeneratedAt($nodes), 'policyOid' => $policyOid, 'serialNumber' => $messageImprintIndex === null ? null : $this->findSerialNumber($nodes, $messageImprintIndex)];
    }
    /** @param list<array<array-key, mixed>> $nodes */
