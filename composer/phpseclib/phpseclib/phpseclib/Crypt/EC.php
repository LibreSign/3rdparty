...
use OCA\Libresign\Vendor\phpseclib4\Crypt\EC\BaseCurves\Binary as BinaryCurve;
...
use OCA\Libresign\Vendor\phpseclib4\Crypt\EC\Formats\Keys\PKCS8;
use OCA\Libresign\Vendor\phpseclib4\Crypt\EC\Parameters;
use OCA\Libresign\Vendor\phpseclib4\Crypt\EC\PrivateKey;
use OCA\Libresign\Vendor\phpseclib4\Crypt\EC\PublicKey;
...
use OCA\Libresign\Vendor\phpseclib4\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey(string $curve) : PrivateKey
    {
        ...
        $curve = '\\OCA\\Libresign\\Vendor\\phpseclib4\\Crypt\\EC\\Curves\\' . $curveName;
    ...
    public static function convertPointToPublicKey(string $curveName, #[\SensitiveParameter] string $secret, bool $toPublicKey = \true) : PublicKey|string
    {
