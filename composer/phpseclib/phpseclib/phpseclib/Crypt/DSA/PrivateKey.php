...
namespace OCA\Libresign\Vendor\phpseclib4\Crypt\DSA;

use OCA\Libresign\Vendor\phpseclib4\Crypt\Common;
use OCA\Libresign\Vendor\phpseclib4\Crypt\DSA;
use OCA\Libresign\Vendor\phpseclib4\Crypt\DSA\Formats\Signature\ASN1 as ASN1Signature;
...
final class PrivateKey extends DSA implements Common\PrivateKey
{
    ...
    {
        $this->y ??= $this->g->powMod($this->x, $this->p);
        return ['p' => clone $this->p, 'q' => clone $this->q, 'g' => clone $this->g, 'y' => clone $this->y, 'x' => clone $this->x];
    }
}
