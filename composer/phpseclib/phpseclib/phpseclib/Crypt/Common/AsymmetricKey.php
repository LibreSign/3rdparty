...
abstract class AsymmetricKey
{
    ...
    protected static abstract function onLoad(array $components) : mixed;
    /**
     * The constructor
     */
     ...
     * Loads a private key
     */
    public static function loadPrivateKey(#[\SensitiveParameter] string|array $key, #[\SensitiveParameter] string $password = '') : PrivateKey
    {
     ...
     */
    public static function loadFormat(string $type, #[\SensitiveParameter] string|array $key, #[\SensitiveParameter] ?string $password = null) : static
    {
        self::initialize_static_variables();
        $components = \false;
     ...
     * Loads a private key
     */
    public static function loadPrivateKeyFormat(string $type, #[\SensitiveParameter] string|array $key, #[\SensitiveParameter] ?string $password = null) : PrivateKey
    {
    ...
    private static function loadPlugins(string $format) : void
    {
        if (!isset(self::$plugins[static::ALGORITHM][$format])) {
            ...
            foreach (new \DirectoryIterator(__DIR__ . '/../' . static::ALGORITHM . '/Formats/' . $format . '/') as $file) {
                ...
                $type = 'OCA\\Libresign\\Vendor\\phpseclib4\\Crypt\\' . static::ALGORITHM . '\\Formats\\' . $format . '\\' . $name;
