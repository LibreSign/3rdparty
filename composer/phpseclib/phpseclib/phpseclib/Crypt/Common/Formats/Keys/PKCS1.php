...
abstract class PKCS1 extends PKCS
{
     ...
     */
    protected static function loadHelper(#[\SensitiveParameter] string $key, #[\SensitiveParameter] ?string $password = null) : string
    {
     ...
     */
    protected static function wrapPrivateKey(#[\SensitiveParameter] string $key, string $type, #[\SensitiveParameter] ?string $password, array $options = []) : string
    {
        if (!isset($password)) {
