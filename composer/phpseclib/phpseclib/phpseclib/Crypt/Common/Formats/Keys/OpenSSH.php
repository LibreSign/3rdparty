...
abstract class OpenSSH
{
     ...
     */
    protected static function wrapPrivateKey(string $publicKey, #[\SensitiveParameter] string $privateKey, #[\SensitiveParameter] ?string $password, array $options) : string
    {
