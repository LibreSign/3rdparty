...
class Blowfish extends BlockCipher
{
     ...
     */
    public static function bcrypt_pbkdf(#[\SensitiveParameter] string $pass, string $salt, int $keylen, int $rounds) : string
    {
    ...
    protected function encryptBlock(string $in) : string
    {
        ...
        $l = $in[1];
        $r = $in[2];
        [$r, $l] = \PHP_INT_SIZE == 4 ? self::encryptBlockHelperSlow($l, $r, $sb, $p) : self::encryptBlockHelperFast($l, $r, $sb, $p);
        return \pack("N*", $r, $l);
    }
    /**
