...
abstract class libsodium
{
     ...
     * @psalm-suppress PossiblyUnusedParam
     */
    public static function savePrivateKey(#[\SensitiveParameter] BigInteger $privateKey, Ed25519 $curve, array $publicKey, #[\SensitiveParameter] ?string $secret = null, #[\SensitiveParameter] ?string $password = null, array $options = []) : string
    {
        if (!isset($secret)) {
