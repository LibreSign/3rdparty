...
abstract class PublicKeyLoader
{
     ...
     */
    public static function load(#[\SensitiveParameter] string|array $key, #[\SensitiveParameter] ?string $password = null) : AsymmetricKey
    {
     ...
     * Loads a private key
     */
    public static function loadPrivateKey(#[\SensitiveParameter] string|array $key, #[\SensitiveParameter] ?string $password = null) : PrivateKey
    {
