...
class ChaCha20 extends Salsa20
{
    ...
    protected function isValidEngineHelper(int $engine) : bool
    {
        ...
        switch ($engine) {
            ...
            case self::ENGINE_OPENSSL_AEAD:
                ...
                return \extension_loaded('openssl') && \PHP_VERSION_ID >= 80200 && $this->key_length == 32 && $this->usePoly1305 && !isset($this->poly1305Key) && $this->counter == 0 && \strlen($this->nonce ?? '') == 12 && !$this->continuousBuffer && \in_array('chacha20-poly1305', \openssl_get_cipher_methods());
    ...
    private function encrypt_with_libsodium(string $plaintext) : string
    {
        ...
        $this->newtag = $this->usingGeneratedPoly1305Key ? \substr($ciphertext, \strlen($plaintext)) : $this->poly1305($newciphertext);
    ...
    private function decrypt_with_libsodium(string $ciphertext) : string
    {
        ...
        if (isset($this->poly1305Key)) {
            ...
            if ($this->usingGeneratedPoly1305Key) {
                $plaintext = \strlen($this->nonce) == 8 ? \sodium_crypto_aead_chacha20poly1305_decrypt(...$params) : \sodium_crypto_aead_chacha20poly1305_ietf_decrypt(...$params);
                $this->oldtag = null;
                if ($plaintext === \false) {
