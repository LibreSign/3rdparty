...
abstract class MSBLOB
{
     ...
     */
    private const CALG_RSA_KEYX = 0xa400;
    /**
     * RSA public key exchange algorithm
     */
    private const CALG_RSA_SIGN = 0x2400;
    /**
     * Public Key
     */
    ...
    public static function load(#[\SensitiveParameter] string $key, #[\SensitiveParameter] ?string $password = null) : array
    {
        ...
        $publickey = match (\ord($type)) {
            self::PUBLICKEYBLOB, self::PUBLICKEYBLOBEX => \true,
        ...
        ['magic' => $magic, 'bitlen' => $bitlen, 'pubexp' => $pubexp] = \unpack('Vmagic/Vbitlen/a4pubexp', Strings::shift($key, 12));
        switch ($magic) {
            case self::RSA2:
