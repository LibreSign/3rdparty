...
namespace OCA\Libresign\Vendor\phpseclib4\Math;

use OCA\Libresign\Vendor\phpseclib4\Exception\BadConfigurationException;
use OCA\Libresign\Vendor\phpseclib4\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable
{
    ...
    {
        self::$engines = [];
        $fqmain = 'OCA\\Libresign\\Vendor\\phpseclib4\\Math\\BigInteger\\Engines\\' . $main;
    ...
    private static function initialize_static_variables() : void
    {
        if (!isset(self::$mainEngine)) {
            $engines = [['GMP', ['DefaultEngine']], ['PHP64', ['OpenSSL']], ['BCMath64', ['OpenSSL']], ['BCMath', ['OpenSSL']], ['PHP32', ['OpenSSL']], ['PHP64', ['DefaultEngine']], ['PHP32', ['DefaultEngine']]];
