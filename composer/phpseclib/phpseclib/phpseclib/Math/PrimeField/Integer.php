 ...
 */
namespace OCA\Libresign\Vendor\phpseclib4\Math\PrimeField;
...
use OCA\Libresign\Vendor\phpseclib4\Math\Common\FiniteField\Integer as Base;
/**
 * Prime Finite Fields
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class Integer extends Base
{
    ...
    {
        unset(static::$modulo[$instanceID], static::$reduce[$instanceID], static::$zero[$instanceID], static::$one[$instanceID], static::$two[$instanceID], static::$mask[$instanceID]);
    }
    /**
     * Returns the modulo
     */
