...
{
    public const MAP = ['type' => ASN1::TYPE_SEQUENCE, 'children' => ['extendedCertificateInfo' => ExtendedCertificateInfo::MAP, 'signatureAlgorithm' => AlgorithmIdentifier::MAP, 'attributes' => ['type' => ASN1::TYPE_BIT_STRING]]];
}
