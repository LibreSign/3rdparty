...
{
    public const MAP = ['type' => ASN1::TYPE_SEQUENCE, 'children' => ['type' => ['constant' => 0, 'optional' => \true, 'implicit' => \true, 'default' => 'color'] + LogotypeImageType::MAP, 'fileSize' => ['type' => ASN1::TYPE_INTEGER], 'xSize' => ['type' => ASN1::TYPE_INTEGER], 'ySize' => ['type' => ASN1::TYPE_INTEGER], 'resolution' => ['optional' => \true] + LogotypeImageResolution::MAP, 'language' => ['type' => ASN1::TYPE_IA5_STRING, 'constant' => 4, 'optional' => \true, 'implicit' => \true]]];
}
