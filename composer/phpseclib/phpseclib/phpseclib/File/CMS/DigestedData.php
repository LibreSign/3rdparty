...
class DigestedData implements \ArrayAccess, \Countable, \Iterator
{
    ...
    public function __construct(string $data, $hashAlgorithm = 'sha256')
    {
        ...
        $this->cms = ['contentType' => 'id-digestedData', 'content' => [
            ...
            'encapContentInfo' => ['eContentType' => 'id-data', 'eContent' => new OctetString($data)],
    ...
    public function toString(array $options = []) : string
    {
        if ($this->cms instanceof Constructed) {
            ...
            $temp = [
                ...
                // 99% of the time this'll be 'id-digestedData'
