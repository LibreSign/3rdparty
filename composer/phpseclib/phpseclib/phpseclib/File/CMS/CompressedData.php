...
class CompressedData implements \ArrayAccess, \Countable, \Iterator
{
    ...
    public function __construct(string $data)
    {
        ...
        $this->cms = ['contentType' => 'id-ct-compressedData', 'content' => ['version' => 'v0', 'compressionAlgorithm' => ['algorithm' => 'id-alg-zlibCompress'], 'encapContentInfo' => ['eContentType' => 'id-data', 'eContent' => \zlib_encode($data, \ZLIB_ENCODING_DEFLATE)]]];
    }
    ...
    public function toString(array $options = []) : string
    {
        if ($this->cms instanceof Constructed) {
            ...
            $temp = [
                ...
                // 99% of the time this'll be 'id-compressedData'
