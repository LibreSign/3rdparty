...
namespace OCA\Libresign\Vendor\phpseclib4\File\CMS\EnvelopedData;
...
class PasswordRecipient extends Recipient implements DerivableKey, SearchableKey
{
    ...
    public function withPassword(#[\SensitiveParameter] string $password) : self
    {
        if ($this->recipient['keyEncryptionAlgorithm']['algorithm'] != 'id-alg-PWRI-KEK') {
            throw new UnsupportedAlgorithmException('id-alg-PWRI-KEK is the only supported keyEncryptionAlgorithm (' . $this->recipient['keyEncryptionAlgorithm']['algorithm'] . ' found)');
        }
