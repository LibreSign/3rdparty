...
class SignedData implements \ArrayAccess, \Countable, \Iterator, Signable
{
    ...
    public function __construct(mixed $data)
    {
        ...
        $this->cms = ['contentType' => 'id-signedData', 'content' => [
            'version' => 'v1',
            'digestAlgorithms' => [],
    ...
    private function compile() : void
    {
        ...
        $temp = self::load($this->toString(['binary' => \true]))['content'];
    ...
    public function toString(array $options = []) : string
    {
        if ($this->cms instanceof Constructed) {
            ...
            $temp = [
                ...
                // 99% of the time this'll be 'id-signedData'
    ...
    public function addESSSigner(X509 $x509, int $type = CMS::ISSUER_AND_DN) : Signer
    {
        ...
        $skeleton['signedAttrs'][] = ['type' => 'id-aa-signingCertificateV2', 'value' => [['certs' => [[
            ...
            'issuerSerial' => ['issuer' => [['directoryName' => $x509['tbsCertificate']['issuer']]], 'serialNumber' => $x509['tbsCertificate']['serialNumber']],
        ]]]]];
