...
trait Extension
{
    private static function getMapping(string $extnId) : array|bool|null
    {
        ...
        return match ($extnId) {
            ...
            '1.3.6.1.4.1.311.20.2' => \true,
            // szOID_ENROLL_CERTTYPE_EXTENSION
            '1.3.6.1.4.1.311.21.1' => \true,
    ...
    public static function mapInExtensions(Constructed $ext) : void
    {
        ...
        switch ($extnId) {
            ...
            case 'id-ce-cRLDistributionPoints':
                ...
                $rule =& Arrays::subArray($rules, $path, \true);
        ...
        try {
            if (isset($map)) {
                ...
                $ext['extnValue'] = \is_array($temp) && $temp['content'] instanceof Constructed ? new Element($ext['extnValue']->value) : $temp;
            }
        } catch (\Exception $e) {
    ...
    private static function getExtensionCriticalValue(string $name) : bool
    {
        return match ($name) {
            'id-ce-keyUsage' => \true,
            'id-ce-nameConstraints' => \true,
            'id-ce-policyConstraints' => \true,
            'id-ce-inhibitAnyPolicy' => \true,
