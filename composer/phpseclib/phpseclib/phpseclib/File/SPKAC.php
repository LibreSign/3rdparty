...
class SPKAC implements \ArrayAccess, \Countable, \Iterator, Signable
{
    ...
    private Constructed|array $spkac = ['publicKeyAndChallenge' => [
        'spki' => ['algorithm' => ['algorithm' => '0.0'], 'subjectPublicKey' => "\x00"],
        ...
        'challenge' => '',
    ], 'signatureAlgorithm' => ['algorithm' => '0.0'], 'signature' => "\x00"];
    /**
     * Binary key flag
     */
    ...
    {
        $this->spkac['publicKeyAndChallenge']['spki'] = ['algorithm' => ['algorithm' => '0.0'], 'subjectPublicKey' => "\x00"];
    }
    ...
    {
        $this->spkac['publicKeyAndChallenge']['challenge'] = $challenge & \str_repeat("", \strlen($challenge));
    }
    /** @psalm-suppress PossiblyUnusedMethod */
    ...
    public function toString(array $options = []) : string
    {
        ...
        if ($publicKey instanceof PublicKey) {
            $origKey = $publicKey;
            $this->spkac['publicKeyAndChallenge']['spki'] = new Element($publicKey->toString('PKCS8', ['binary' => \true]));
        }
    ...
    {
        $this->spkac['signature'] = new BitString("\x00{$signature}");
    }
    /**
    ...
    {
        return self::validateSignatureHelper($this->getPublicKey(), $this->spkac['signatureAlgorithm']['algorithm'], $this->spkac['signature'], $this->spkac['publicKeyAndChallenge']->getEncoded());
    }
