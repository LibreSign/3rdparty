...
namespace OCA\Libresign\Vendor\phpseclib4\System\SSH;
...
use OCA\Libresign\Vendor\phpseclib4\Net\SSH2;
use OCA\Libresign\Vendor\phpseclib4\System\SSH\Agent\Identity;
/**
...
class Agent
{
    ...
    {
        $address = $address ?? $_SERVER['SSH_AUTH_SOCK'] ?? $_ENV['SSH_AUTH_SOCK'] ?? throw new BadConfigurationException('SSH_AUTH_SOCK not found');
