...
if (\extension_loaded('odbc')) {
    if (!\function_exists('OCA\\Libresign\\Vendor\\odbc_connection_string_is_quoted')) {
        /** @internal */
    ...
    if (!\function_exists('OCA\\Libresign\\Vendor\\odbc_connection_string_should_quote')) {
        /** @internal */
    ...
    if (!\function_exists('OCA\\Libresign\\Vendor\\odbc_connection_string_quote')) {
        /** @internal */
