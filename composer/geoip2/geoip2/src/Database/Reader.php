...
namespace OCA\Libresign\Vendor\GeoIp2\Database;

use OCA\Libresign\Vendor\GeoIp2\Exception\AddressNotFoundException;
use OCA\Libresign\Vendor\GeoIp2\Model\AnonymousIp;
use OCA\Libresign\Vendor\GeoIp2\Model\AnonymousPlus;
use OCA\Libresign\Vendor\GeoIp2\Model\Asn;
use OCA\Libresign\Vendor\GeoIp2\Model\City;
use OCA\Libresign\Vendor\GeoIp2\Model\ConnectionType;
use OCA\Libresign\Vendor\GeoIp2\Model\Country;
use OCA\Libresign\Vendor\GeoIp2\Model\Domain;
use OCA\Libresign\Vendor\GeoIp2\Model\Enterprise;
use OCA\Libresign\Vendor\GeoIp2\Model\Isp;
use OCA\Libresign\Vendor\GeoIp2\ProviderInterface;
use OCA\Libresign\Vendor\MaxMind\Db\Reader as DbReader;
use OCA\Libresign\Vendor\MaxMind\Db\Reader\InvalidDatabaseException;
use OCA\Libresign\Vendor\MaxMind\Db\Reader\Metadata;
/**
...
class Reader implements ProviderInterface
{
    ...
    {
        return $this->flatModelFor(AnonymousPlus::class, 'GeoIP-Anonymous-Plus', $ipAddress);
    }
    /**
